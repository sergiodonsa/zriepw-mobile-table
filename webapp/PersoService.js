sap.ui.define(['jquery.sap.global'],
	...
	var DemoPersoService = {
		...
		oData : {
			...
			aColumns : [
				{
					id: "zriepw-productsTable-productCol",
					order: 2,
					text: "Product",
					visible: true
				},
				{
					id: "zriepw-productsTable-supplierCol",
					order: 1,
					text: "Supplier",
					visible: true
				},
				{
					id: "zriepw-productsTable-dimensionsCol",
					order: 0,
					text: "Dimensions",
					visible: false
				},
				{
					id: "zriepw-productsTable-weightCol",
					order: 3,
					text: "Weight",
					visible: true
				},
				{
					id: "zriepw-productsTable-priceCol",
					order: 4,
					text: "Price",
					visible: true
				}
